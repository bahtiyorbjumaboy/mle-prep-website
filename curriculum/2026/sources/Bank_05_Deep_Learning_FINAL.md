...
### A1 — Backpropagation and Training Memory
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A1
...
### A3 — Xavier, He, and Failed Initialization
**Phase:** G1  
**Depth:** D3  
**Source mapping:** A3
...
### A4 — Activation Function Selection
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A4
...
### A5 — Normalization, Dropout, and Train/Eval State
**Phase:** G1  
**Depth:** D3  
...
### A7 — Deep-Network Regularization
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A7
...
### A8 — SGD, Momentum, Adam, and AdamW
**Phase:** G1  
**Depth:** D2  
...
### A10 — Learning-Rate Warmup and Scheduling
**Phase:** G1  
**Depth:** D2  
...
### A11 — Hessians, Saddles, and Loss-Surface Sharpness
**Phase:** G1  
**Depth:** D3  
...
### A12 — Diagnosing Training-Loss Curves
**Phase:** G1  
**Depth:** D3  
**Source mapping:** A12
...
### A13 — Stable Cross-Entropy and Mixed Precision
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A13
...
### A15 — Convolutions and Image Inductive Bias
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A15
...
### A16 — Residual Connections and Normalization Placement
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A16
...
### A17 — Self-Attention and Positional Encoding
**Phase:** G1  
**Depth:** D3  
...
### A19 — Transformer Block Parameters and Compute
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A19
...
### A20 — Embedding Layers and Rare Items
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A20
...
### A21 — Contrastive Learning and Two-Tower Training
**Phase:** G1  
**Depth:** D2  
...
### A23 — Transfer Learning with ResNet
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A23
...
### A25 — Quantization and Knowledge Distillation
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A25
...
### A26 — GPU Inference Capacity Planning
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A26
...
### A27 — Debugging a Network That Will Not Train
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A27
...
### A28 — LSTM Gates and Attention Tradeoffs
**Phase:** G1  
**Depth:** D2  
**Source mapping:** A28
...
### B30 — Epochs, Batches, Steps, and Accumulation
**Phase:** G2  
**Depth:** D1  
**Source mapping:** B30
...
### B31 — Forward and Backward Pass State
**Phase:** G2  
**Depth:** D1  
**Source mapping:** B31
...
### B32 — Pretraining, Fine-Tuning, and Feature Extraction
**Phase:** G2  
**Depth:** D1  
**Source mapping:** B32
...
### B36 — Embedding Dimension Tradeoffs
**Phase:** G2  
**Depth:** D1  
**Source mapping:** B36
